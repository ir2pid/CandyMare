...
public:
	...
	//========================================================
				if(layout.levelEndLayout->cZap.listen(touchX, touchY))
				{//cZap
					touchOn = true;
					touchID = 5;
					vibrate.vibrate10();
					soundPlayer.playPress();
					layout.levelEndLayout->cZap.render(true);
				}
				else
				{
					layout.levelEndLayout->cZap.render(false);
				}//cZap
	...
	//========================================================
				if(touchID == 5 && layout.levelEndLayout->cZap.listen(touchX, touchY))
				{
					layout.levelEndLayout->cZap.render(true);
				}
				else
	...
	//========================================================
				if(layout.menuLayout->cZap.listen(touchX, touchY))
				{//cZap
					touchOn = true;
					touchID = 4;
					vibrate.vibrate10();
					soundPlayer.playPress();
					layout.menuLayout->cZap.render(true);
				}
				else
				{
					layout.menuLayout->cZap.render(false);
				}//cZap
	//========================================================
	...
	//========================================================
				if(touchID == 4 && layout.menuLayout->cZap.listen(touchX, touchY))
				{
					layout.menuLayout->cZap.render(true);
				}
				else
