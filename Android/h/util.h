...
public:
	...
	AppiraterSystem appiraterSystem;
	AdNinjaSystem adNinjaSystem;
	int32 widthGame;
	int32 heightGame;
	int32 widthDisplay;
	int32 heightDisplay;
	...
	void construct()
	{
		...
		if(widthDisplay >= 960 && heightDisplay >= 640)
		{
			...
			else if(widthDisplay >= 1280 && heightDisplay >= 800)
			{				
				//gameRes = R1280x800;
				widthGame = 1280;
				heightGame = 800;	
			...
			else if(widthDisplay >= 1366 && heightDisplay >= 768)
			{				
				//gameRes = R1366x768;
				widthGame = 1366;
				heightGame = 768;	
		...
		else if(widthDisplay >= 800 && heightDisplay >= 480)
		{
			em = 1.68f;
			BLOCKSIZE = 72;			
			PATH = "./texture/800x480/";	
		
			if(widthDisplay >= 800 && heightDisplay >= 600)
			{
				//gameRes = R800x600;
				widthGame = 800;
				heightGame = 600;
			...
			else if(widthDisplay >= 960 && heightDisplay >= 540)
			{				
				//gameRes = R960x540;
				widthGame = 960;
				heightGame = 540;	
			...
			else if(widthDisplay >= 854 && heightDisplay >= 480)
			{				
				//gameRes = R854x480;
				widthGame = 854;
				heightGame = 480;	
			...
			else if(widthDisplay >= 1024 && heightDisplay >= 600)
			{				
				//gameRes = R1024x600;
				widthGame = 1024;
				heightGame = 600;	
		...
		else//if(widthDisplay == 480 && heightDisplay == 320)//|| widthDisplay == 800 && heightDisplay == 600)
		{
			...
			if(widthDisplay >= 640 && heightDisplay >= 360)
			{
				//gameRes = R640x360;
				widthGame = 640;
				heightGame = 360;
...
/*#if defined(IOS)
	...
	void mountTex()
	{
		if(widthDisplay >= 960 && heightDisplay >= 640)
			...
			dzArchiveAttach("./data800x480.ninja");
		else// if(widthDisplay >= 480)
	...
	{		
		...
		else if(widthDisplay >= 960 && heightDisplay >= 640)
			dzArchiveAttach("./data960x640.ninja");
		else if(widthDisplay >= 800 && heightDisplay >= 480)
			dzArchiveAttach("./data800x480.ninja");
		else// if(widthDisplay >= 480)
